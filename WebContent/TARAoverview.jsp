...
<div id="content">
<h4 class='liketext'><img style='height: 50px; width: 50px; margin-left: auto;' src='Images/security overview.JPG'/>&nbsp &nbsp TARA assessments</h4>
<div class="scrolledView" id="left">
 <ul class='tree'>
  <li><a href="#"><img src='Images/asset management.PNG' class= "imageIcons"/> &nbsp Assets</a>
    <ul>
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Confidentiality of cryptographic key material which is stored on the ECU</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          	<ul>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Confidentiality of SW Update</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Authenticity of SW Update </a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
          		<li><a href="#"><img class= "imageIcons" src='Images/attacks icon.JPG'/> &nbsp Jamming</a></li>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Confidentiality of cryptographic key material which is stored in the backend</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
           <ul>
          		<li><a href="#"><img class= "imageIcons" src='Images/attacks icon.JPG'/> &nbsp Jamming</a></li>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Integrity of installed ECU SW</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Software update (stored at backend, in transit etc.)</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Asymmetric software/command signing keys</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp OTA feature (normal operation)</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
          		<li><a href="#"><img class= "imageIcons" src='Images/attacks icon.JPG'/> &nbsp Disable or denial of service</a></li>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Vehicle functions (normal operation)</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
          		<li><a href="#"><img class= "imageIcons" src='Images/attacks icon.JPG'/> &nbsp Malware flashed with OBD update</a></li>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Part numbers and data</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
          		<li><a href="#"><img class= "imageIcons" src='Images/attacks icon.JPG'/> &nbsp Corrupt code or data</a></li>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp TCAM routing tables</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp TCAM functionality (normal connectivity)</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          	<ul>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Update policies and hashing</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          	<ul>
          		<li><a href="#"><img class= "imageIcons" src='Images/attacks icon.JPG'/> &nbsp Denial of service</a></li>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Log files</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          	<ul>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Swap/rollback/erase commands at TCAM</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Personal identity information</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
          		<li><a href="#"><img class= "imageIcons" src='Images/attacks icon.JPG'/> &nbsp Illegal acquisition, modification or breaking</a></li>
      ...
      <li><a href="#"><img class= "imageIcons" src='Images/icon for assets.JPG'/> &nbsp Trigger condition signals</a>
        <ul>
          <li><a href="#"><img class= "imageIcons" src='Images/attack management.PNG'/> &nbsp Security goal</a>
          <ul>
          		<li><a href="#"><img class= "imageIcons" src='Images/attacks icon.JPG'/> &nbsp Illegal acquisition, modification or breaking</a></li>
 ...
 <br><p class = "secinfo">Click on individual security goal IDs from the left structure to view corresponding TARA assessments</p>
